...
namespace MicroRabbit.Infra.Bus
{
     ...
     * RabbitMQBus class 
     * 
     * The class is sealed to prevnt others from
     * inheriting from this class or extending
     * 
     * @author D. P. Edwards
     * @license MIT
     * @version 1.0
    ...
    public sealed class RabbitMQBus : IEventBus
    {
        ...
        public RabbitMQBus(IMediator mediator, IServiceScopeFactory serviceScopeFactory, IConnection connection)
        {
            _mediator = mediator;
        ...
        private void StartBasicConsume<T>() where T : Event
        {
            ...
            //var factory = new ConnectionFactory()
            //{
            //    Endpoint = new AmqpTcpEndpoint("eventbus"),
            //    DispatchConsumersAsync = true
            //};
